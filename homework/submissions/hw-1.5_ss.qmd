...
# your code here 
library(readr)
laryngoscope <- read_csv("laryngoscope-clean.csv")
View(laryngoscope)
```
...
weight_kg <- 0.453592*c(127.0, 147.7, 262.2, 248.9, 152.0, 217.7)
height_m <- 0.0254*c(64.8, 59.0, 66.6, 51.7, 61.1, 54.8)
bmi_2 <- weight_kg/(height_m)^2
703*(weight_lbs/(height_in)^2)
mean(bmi_2)
mean(laryngoscope$BMI)
#the BMI 1 group has a higher mean
...
c(203.0, 150.1, 102.8, 241.0, 189.1, 148.3)
