...
```{r}
library(readr)
read_csv("laryngoscope-clean.csv")
laryngoscope <-  laryngoscope_clean
```
...
signif(mean(laryngoscope$attempt1_time),2)
```
...
703 * (c(127.0, 147.7, 262.2, 248.9, 152.0, 217.7) / c(64.8, 59.0, 66.6, 51.7, 61.1, 54.8)) 
