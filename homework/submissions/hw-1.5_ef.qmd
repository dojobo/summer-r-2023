...
#library(readr)
# your code here 
#read_csv("Desktop/laryngoscope-clean.csv")
#laryngoscope <- read_csv("Desktop/laryngoscope-clean.csv")
...
#time <- laryngoscope$attempt1_time
#mean(time)
#round(mean(time), 2)
```
...
# your code here 
#weight_kgs <- (weight_lbs * 0.454)
#height_m <- (height_in * 0.0254)
#(weight_kgs)/((height_m)^2)
#bmi_2 <- ((weight_kgs)/((height_m)^2))
#703* ((weight_lbs)/((height_in)^2))
#mean(bmi_2)
#laryngoscope$BMI
#mean(laryngoscope$BMI)
#41.91 (laryngoscope) and 39.66 (mine)
```
